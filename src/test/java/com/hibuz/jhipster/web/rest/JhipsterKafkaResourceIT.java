...
import com.hibuz.jhipster.config.KafkaProperties;
...
class JhipsterKafkaResourceIT {
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
